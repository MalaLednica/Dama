...
public class Kruh {
    ...
    public void zmenPolohu(int lavyHornyX, int lavyHornyY) {
        ...
        if (this.getViditelnost()) {
            this.nakresli();
        }
    }
    
    /**
     * Vráti true, ak je kruh zobrazený na plátne.
     */
    ...
    /**
     * Vráti true, kruh obsahuje súradnice z parametra x a y.
     */
    public boolean obsahujeSuradnice(int x, int y) {
        if ((x >= this.lavyHornyX && x <= this.lavyHornyX + this.priemer)
            && (y >= this.lavyHornyY && y <= this.lavyHornyY + this.priemer)) {
    ...
    /**
     * Vráti x-ovú súradnicu ľavého horného rohu kruhu.
     */
    public int getX() {
    ...
    /**
     * Vráti y-ovú súradnicu ľavého horného rohu kruhu.
     */
    public int getY() {
    ...
    /**
     * Vráti hodnotu pomocného atribútu využívaného v triede Hra (atribút slúži na detekciu vyhadzovacích ťahov v hre).
     */
    public boolean getVyhod() {
        return this.vyhod;
    }
    
    /**
     * Nastaví hodnotu pomocného atribútu využívaného v triede Hra (atribút slúži na detekciu vyhadzovacích ťahov v hre).
     */
    public void setVyhod(boolean vyhod) {
        this.vyhod = vyhod;
    }
}
